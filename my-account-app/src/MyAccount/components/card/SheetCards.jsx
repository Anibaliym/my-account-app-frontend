...
export const SheetCards = ({ sheetCards, showUserMessage, fetchCard }) => {
...
{/* 
                    <div  className="excel-card animate__animated animate__fadeInDown animate__faster">
                        <div className="excel-card-header">
                            <h1 className="display-6" style={{ fontSize:'20px' }}>TEST</h1>
                        </div>
                        ...
                        <div className="excel-card-row">
                            ...
                            <div className="excel-card-row">
                                <div className="excel-card-cell description">Pichidangui - gastos comunes</div>
                                <div className="excel-card-cell value">$232.000</div>
                                <div className="excel-card-cell action">
                                    <i className='bx bx-check-circle icon'></i>
                                    <i className='bx bx-trash icon'></i>
